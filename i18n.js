...
(function(){
  const T = {
    ...
    otp_verify_title:{en:"Verify your email",zhTW:"驗證您的電郵",zhCN:"验证您的电邮"},
    otp_verify_subtitle:{en:"We've sent a code to",zhTW:"我們已發送驗證碼至",zhCN:"我们已发送验证码至"},
    otp_incorrect:{en:"Incorrect code. Please try again.",zhTW:"驗證碼不正確，請重試。",zhCN:"验证码不正确，请重试。"},
    otp_resend:{en:"Resend code",zhTW:"重新發送驗證碼",zhCN:"重新发送验证码"},
    otp_verified:{en:"You're verified!",zhTW:"驗證成功！",zhCN:"验证成功！"},
    otp_continue:{en:"Continue",zhTW:"繼續",zhCN:"继续"},
